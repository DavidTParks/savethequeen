    ...
    <div class="container max-w-5xl mx-auto pt-32 px-4">
      ...
      >
        ...
        <nuxt-link
          to="/candles"
          href="#"
          class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10 mt-12"
        >Continue Shopping</nuxt-link>
      </div>
                ...
                <td class="pb-4 pt-4 inline-flex flex-shrink flex-col md:flex-row">
                  ...
                  <div class="inline-flex flex-col ml-0 md:ml-4">
                    ...
                    <a
                      ...
                      class="cursor-pointer w-32 mt-4 flex items-center justify-center px-4 py-1 border border-transparent text-xs leading-6 font-medium rounded-md text-gray-200 bg-gray-900 hover:text-white hover:bg-gray-800 focus:outline-none focus:shadow-outline focus:border-red-300 transition duration-150 ease-in-out"
                    >Remove</a>
                  </div>
                </td>
