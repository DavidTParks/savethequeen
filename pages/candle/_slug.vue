        ...
        <template v-else>
            ...
            <div class="flex flex-col pt-4 py-12 sm:flex-row">
                ...
                <div class="w-full sm:w-1/2 px-4 sm:px-6 lg:px-8 mt-4 sm:mt-0">
                    ...
                    <p class="text-base text-gray-900 mt-4 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-4 md:text-xl lg:mx-0">{{candle.description}}</p>
            ...
            <div class="py-12">
                <h2 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10 mt-0 lg:text-center"
                >Related Products</h2>
                <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-4 sm:mt-12">
