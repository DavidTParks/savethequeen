<template>
    <div class="w-full cursor-pointer relative mb-8 sm:my-0">
        <nuxt-link :to="`/candle/${product.id}`">
            <img class="object-cover h-96 sm:h-64 w-full overflow-hidden rounded-lg shadow-lg" :src="product.images[0].src" :alt="product.images[0].altText">
        </nuxt-link>
