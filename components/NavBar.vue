...
<div class="max-w-screen-xl mx-auto flex items-center justify-between max-w-screen-xl mx-auto">
  <div class="relative flex items-center py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-sm leading-5 flex items-center md:pr-4 mr-2">
      ...
      <nuxt-link class="ml-8 mr-2 sm:mr-0 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out relative" to="/cart">
